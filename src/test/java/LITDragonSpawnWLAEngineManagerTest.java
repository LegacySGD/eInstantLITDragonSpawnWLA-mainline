...
public class LITDragonSpawnWLAEngineManagerTest
{
	...
	{
		logger = Logger.getLogger(LITDragonSpawnWLAEngineManagerTest.class);
		gameParams = XMLUtil.parseResource("paymodel/LITDragonSpawnWLAIW/GameParams.xml").getDocumentElement();
		previousOutcome = XMLUtil.parseResource("paymodel/LITDragonSpawnWLAIW/InitOutcome.xml").getDocumentElement();
